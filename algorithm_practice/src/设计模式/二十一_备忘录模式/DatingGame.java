...
class DatingGameWin extends JFrame implements ActionListener
{
    ...
    DatingGameWin()
    {
        ...
        FileName="/home/vincent/github/algorithm_practice/src/设计模式/二十一_备忘录模式/Photo/四大美女.jpg";
    ...
    void showPicture(String name)
    {
        ...
        EastJP.repaint(); //刷新屏幕
        you.setWife(name);
        FileName="/home/vincent/github/algorithm_practice/src/设计模式/二十一_备忘录模式/Photo/"+name+".jpg";
        g=new JLabel(new ImageIcon(FileName),JLabel.CENTER);
        EastJP.add(g);
