...
class SteamedCrabs extends JLabel implements CrabCooking
{
    ...
    {
        this.setIcon(new ImageIcon("/home/vincent/github/algorithm_practice/src/设计模式/十三_策略模式/SteamedCrabs.jpg"));
...
class BraisedCrabs extends JLabel implements CrabCooking
{
    ...
    public void CookingMethod()
    {
        this.setIcon(new ImageIcon("/home/vincent/github/algorithm_practice/src/设计模式/十三_策略模式/BraisedCrabs.jpg"));
        this.setHorizontalAlignment(CENTER);
    }
}
//环境类：厨房
